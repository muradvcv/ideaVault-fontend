...
const Navbar = () => {
  ...
  const privateLinks = [
    ...
    { name: "My Interaction", path: "/myInteration" },
  ];
              ...
              <li className="relative list-none">
                <details className="group">
                  ...
                  <div className="absolute right-0 top-14 w-36 rounded-xl bg-base-100 shadow-lg border z-50 overflow-hidden">
                    <Link
                      href="/my-profile"
                      className="px-4 py-3 flex items-center gap-2 text-sm hover:bg-gray-100"
                    >
                      <FiUser />
                      <span>Profile</span>
                    </Link>
                    ...
                    <button
                      ...
                      className="w-full text-left px-4 py-3 text-red-500 flex items-center gap-2 text-sm hover:bg-gray-100"
                    >
                      <MdLogout />
                      <span>Logout</span>
                    </button>
